let User,AppError,cloudinary,fs,sendEmail,crypto;_a76‍.x([["register",()=>register],["login",()=>login],["logout",()=>logout],["getProfile",()=>getProfile],["forgotPassword",()=>forgotPassword],["resetPassword",()=>resetPassword],["changePassword",()=>changePassword],["updateUser",()=>updateUser]]);_a76‍.w("../models/user.model",[["default",["User"],function(v){User=v}]]);_a76‍.w("../utils/error.util",[["default",["AppError"],function(v){AppError=v}]]);_a76‍.w("cloudinary",[["default",["cloudinary"],function(v){cloudinary=v}]]);_a76‍.w("fs/promises",[["default",["fs"],function(v){fs=v}]]);_a76‍.w("dotenv/config");_a76‍.w("../utils/sendEmail",[["default",["sendEmail"],function(v){sendEmail=v}]]);_a76‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);
...
const register=async(req,res,next)=>{
    ...
    //TODO:File upload
    _a76‍.g.console.log('File Details>',JSON.stringify(req.file));
    if(req.file){
        try{
...
const forgotPassword=async(req,res,next)=>{
   ...
   _a76‍.g.console.log(resetPasswordURL);
