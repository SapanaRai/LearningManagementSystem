let User,AppError,cloudinary,fs,sendEmail,crypto;_003‍.x([["register",()=>register],["login",()=>login],["logout",()=>logout],["getProfile",()=>getProfile],["forgotPassword",()=>forgotPassword],["resetPassword",()=>resetPassword],["changePassword",()=>changePassword],["updateUser",()=>updateUser]]);_003‍.w("../models/user.model",[["default",["User"],function(v){User=v}]]);_003‍.w("../utils/error.util",[["default",["AppError"],function(v){AppError=v}]]);_003‍.w("cloudinary",[["default",["cloudinary"],function(v){cloudinary=v}]]);_003‍.w("fs/promises",[["default",["fs"],function(v){fs=v}]]);_003‍.w("dotenv/config");_003‍.w("../utils/sendEmail",[["default",["sendEmail"],function(v){sendEmail=v}]]);_003‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);
...
const register=async(req,res,next)=>{
    ...
    //TODO:File upload
    _003‍.g.console.log('File Details>',JSON.stringify(req.file));
    if(req.file){
        try{
...
const forgotPassword=async(req,res,next)=>{
   ...
   _003‍.g.console.log(resetPasswordURL);
